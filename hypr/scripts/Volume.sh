...
iDIR="/home/ekrem/.config/hypr/mako/"
...
get_icon() {
	...
	if [[ "$current" -eq "0" ]]; then
		echo "/home/ekrem/.config/hypr/mako/volume-mute.png"
	elif [[ ("$current" -ge "0") && ("$current" -le "30") ]]; then
		echo "/home/ekrem/.config/hypr/mako/volume-mid.png"
	elif [[ ("$current" -ge "60") && ("$current" -le "120") ]]; then
		echo "/home/ekrem/.config/hypr/mako/volume-high.png"
	elif [[ ("$current" -ge "122") && ("$current" -le "160") ]]; then
		echo "/home/ekrem/.config/hypr/mako/volume-high.png"
	fi
}
